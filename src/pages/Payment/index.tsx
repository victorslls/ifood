...
import { CustomerDate } from '../../interfaces/CustomerData';
...
export default function Payment(){
  ...
  const onSubmit: SubmitHandler<FieldValues> = data => payOrder(data as unknown as CustomerDate)
  ...
  return (
    <Container>
      ...
      <Inner>
        ...
        <div  className="grouped">
          ...
          <div className="field">
            ...
            <Controller name='email' control={control} render={({field}) => (
              <input type='text' id='fullemailName' autoComplete='email' {...field}/>
              )} />
        ...
        <Controller name='creditCardNumber' control={control} render={({field}) => (
              <IMaskInput
                type='text'
                id='creditCardNumber'
                mask={[
            ...
            { errors.creditCardNumber && <p className='error' > {errors.creditCardNumber.message}</p>}
              ...
              <div className='field'>
                <label htmlFor='creditCardHolder'>Nome impresso no cartão</label>
                 ...
                 <Controller name='creditCardHolder' control={control} render={({field}) => (
              <IMaskInput
                type='text'
                id='creditCardHolder'
            ...
            { errors.creditCardHolder && <p className='error' > {errors.creditCardHolder.message}</p>}
              ...
              <div className='grouped'>
                <div className='field'>
                  ...
                  <Controller name='creditCardExpiration' control={control} render={({field}) => (
                    <IMaskInput
                      type='text'
                ...
                <div className='field'>
                  <label htmlFor='creditCardSecurityCode'>Código de segurança (CVV)</label>
                     ...
                     <Controller name='creditCardSecurityCode' control={control} render={({field}) => (
                            <IMaskInput
                              type='text'
                              id='creditCardSecurityCode'
                              mask={[
                                {mask: '000', maxLength: 4 },
                                {mask: '0000' },
                              ]}
                            {...field}
                            />
